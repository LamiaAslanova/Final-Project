                ...
                <div className="card single__card">
                    ...
                    <div className="card-body card__bottom">
                        ...
                        <div className="card__bottom__bottom">
                            <h3>Drawing attention emerging</h3>
            ...
            <div className="col-4 single__card__col">
                <div className="card single__card">
                    ...
                    <div className="card-body card__bottom">
                        ...
                        <div className="card__bottom__bottom">
                            <h3>Drawing attention emerging</h3>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam, eum? bhahk ADNHILWJL WDNJnj</p>
                            <Link>
                                <span>Book now</span>
                                <i class="fa-solid fa-circle-chevron-right"></i>
                            </Link>
